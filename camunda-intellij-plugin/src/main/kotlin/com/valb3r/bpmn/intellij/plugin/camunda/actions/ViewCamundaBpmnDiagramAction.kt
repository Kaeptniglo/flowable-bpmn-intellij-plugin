...
class ViewCamundaBpmnDiagramAction : BaseViewBpmnDiagramAction() {
    ...
    override fun generateContent(project: Project, file: PsiFile) {
        val window = project.getService(CamundaBpmnPluginToolWindowProjectService::class.java).bpmnToolWindow
    ...
    override fun update(anActionEvent: AnActionEvent) {
        ...
        currentSettingsStateProvider.compareAndSet(null) { ApplicationManager.getApplication().getService(CamundaBpmnPluginSettingsState::class.java) }
